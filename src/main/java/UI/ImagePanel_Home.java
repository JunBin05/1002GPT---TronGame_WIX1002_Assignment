...
public class ImagePanel_Home extends BaseImagePanel {
    ...
    private void updateLayout() {
        ...
        // Setup Sound Button (Bottom Left)
        ...
        // Setup Play Button (Above Sound Button)
        ...
        // Setup Award Button (Beside Leaderboard Button)
        ...
        // Setup Question Button (Right bottom of the window)
        ...
        // Setup Profile Picture Button (Top Right)
        ...
        // Setup ID Box (Beside Profile Picture)
        int boxWidth = 260;
        int boxHeight = 50;
        int boxX = (int) (w * 0.73);
        int boxY = (int) (h * 0.10);
        ...
        // Setup Exit Button (Top Right Corner) (make it beside qna button)
