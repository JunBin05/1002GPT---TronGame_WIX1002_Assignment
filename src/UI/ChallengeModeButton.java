...
public class ChallengeModeButton extends JButton {

    private Image originalImage;

    public ChallengeModeButton(String imagePath) {
        // 1. Load the image
        ...
        addActionListener(e -> {
            System.out.println("Challenge Mode Button Clicked!");
            JOptionPane.showMessageDialog(this, "Challenge Mode Feature Coming Soon!");
        });
    }
